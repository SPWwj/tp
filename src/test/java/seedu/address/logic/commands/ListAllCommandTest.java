...
//         officeConnectModel = new OfficeConnectModel(personRepositoryModelManager, new RepositoryModelManager<>(getTypicalTaskRepository()),
//                 new RepositoryModelManager<>(new Repository<AssignTask>()));
//         expectedofficeConnectModel = new OfficeConnectModel(personRepositoryModelManager, officeConnectModel.getTaskModelManager(),
//                 new RepositoryModelManager<>(new Repository<AssignTask>()));
//     }
//     @Test
