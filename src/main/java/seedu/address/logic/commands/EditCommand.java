...
public class EditCommand extends Command {
    ...
    public CommandResult execute(OfficeConnectModel officeConnectModel) throws CommandException {
        ...
        List<Person> lastShownList = officeConnectModel.getPersonRepositoryModelManager().getFilteredItemList();
        ...
        if (!personToEdit.isSame(editedPerson) && officeConnectModel.getPersonRepositoryModelManager()
            .hasItem(editedPerson)) {
            throw new CommandException(MESSAGE_DUPLICATE_PERSON);
        }

        officeConnectModel.getPersonRepositoryModelManager().setItem(personToEdit, editedPerson);
